...
export class SettingService {
  ...
  static async updateLanguageService(id: string, language: string) {
    const updatedLanguage = await prisma.systemSetting.update({
      where: {
        id: Number(id),
      },
      data: {
    ...
    websocketService.sendToAll("languageUpdate", {
      id: id.toString(),
